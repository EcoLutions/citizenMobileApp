class ApiConstants {
  ...
  static const String citizensEndpoint = '/api/v1/citizens';
  static const String citizenByUserEndpoint = '/api/v1/citizens/user';
  static const String reportsEndpoint = '/api/v1/reports';
  static const String evidencesEndpoint = '/api/v1/evidences';
}